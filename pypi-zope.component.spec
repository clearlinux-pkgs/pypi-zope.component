...
pushd ..
cp -a zope.component-5.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656359955
...
cp %{_builddir}/zope.component-5.0.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-zope.component/a0b53f43aab58b46bf79ba756c50771c605ab4c5
