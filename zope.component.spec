...
export LANG=C
export SOURCE_DATE_EPOCH=1541281109
...
cp LICENSE.txt %{buildroot}/usr/share/package-licenses/zope.component/LICENSE.txt
...
/usr/share/package-licenses/zope.component/LICENSE.txt
