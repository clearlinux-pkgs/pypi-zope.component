...
%prep
%setup -q -n zope.component-5.0.0
cd %{_builddir}/zope.component-5.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616169505
...
cp %{_builddir}/zope.component-5.0.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/zope.component/a0b53f43aab58b46bf79ba756c50771c605ab4c5
